...
import 'package:donor_app/splashScreen/auth_Screen.dart';
import 'package:donor_app/utils/custom_shared_preferences.dart';
...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  List<_SliderModel> mySlides = <_SliderModel>[
    ...
    _SliderModel(
      imageAssetPath: Image.asset(Assets.afterSplash),
